...
const WINDOWS_SERVER_LINK = `https://www.minecraft.net/bedrockdedicatedserver/bin-win/${UNZIPPED_SERVER_FOLDER_NAME}.zip`;
const LINUX_SERVER_LINK = `https://www.minecraft.net/bedrockdedicatedserver/bin-linux/${UNZIPPED_SERVER_FOLDER_NAME}.zip`;
